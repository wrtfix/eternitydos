...
void EternityFrm::CreateGUIControls()
{
	...
	Resolver = new wxButton(this, ID_RESOLVER, wxT("&Resolver mucho"), wxPoint(34,315), wxSize(130,137), 0, wxDefaultValidator, wxT("Resolver"));
	...
	WxSpinCtrl4->SetFont(wxFont(8, wxSWISS, wxNORMAL,wxNORMAL, false, wxT("Tahoma")));
	...
	WxSpinCtrl3->SetFont(wxFont(8, wxSWISS, wxNORMAL,wxNORMAL, false, wxT("Tahoma")));
	...
	WxSpinCtrl2->SetFont(wxFont(8, wxSWISS, wxNORMAL,wxNORMAL, false, wxT("Tahoma")));
	...
	WxSpinCtrl1->SetFont(wxFont(8, wxSWISS, wxNORMAL,wxNORMAL, false, wxT("Tahoma")));
